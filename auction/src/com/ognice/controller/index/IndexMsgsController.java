 ...
 */
@Controller
@RequestMapping(value = "/index//msgs", method = RequestMethod.GET)
public class IndexMsgsController {
    @Resource
    ...
    public String page(ModelMap model, Msgs searchParam, Integer page, Integer pageSize) {
        PageSearchParam pageSearch = new PageSearchParam();
        pageSearch.setPage(page == null ? 1 : page);
        pageSearch.setPagesize(pageSize == null ? 20 : pageSize);
        pageSearch.setParams(searchParam);
    ...
    public String add(HttpServletRequest request, Msgs record, ModelMap model) {
        ...
        record.setCreated(new Date());
            ...
            if (msg.equals("添加成功")) {
                return "redirect:/index/msgs?fromid="+record.getFromid();
            }
