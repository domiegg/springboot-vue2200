...
<section class="carts">
    <div class="container">
        ...
        <form action="${path }/index/msgs/add" method="post">
            <div class="cart-box clearfix">
                <table class="col-xs-12 clearfix">
                    <input type="hidden" name="fromid" value="${indexUser.id }">
                    <input type="hidden" name="toid" value="${record.toid }">
                    <input type="hidden" name="fromname" value="${indexUser.nickname }">

                    <tr class="no-h" style="line-height: 40px;">
                        <td class="len-sm" style="text-align: right">留言：</td>
                        <td class="len-sm no-see"><textarea  style="float: left" required name="msg" ></textarea></td>
                    </tr>
