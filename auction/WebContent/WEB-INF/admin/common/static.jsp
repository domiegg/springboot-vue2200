...
<c:set var="path" value="${pageContext.request.contextPath}"></c:set>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="${path}/static/dist/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="${path}/static/dist/css/ionicons.min.css"><!-- Theme style -->
...
<link rel="stylesheet" type="text/css" href="${path }/static/dist/css/wangEditor.min.css">
...
<!-- InputMask -->
<script src="${path}/static/plugins/input-mask/jquery.inputmask.js"></script>
<script src="${path}/static/plugins/input-mask/jquery.inputmask.date.extensions.js"></script>
<script src="${path}/static/plugins/input-mask/jquery.inputmask.extensions.js"></script>
<!-- date-range-picker -->
...
<script src="${path}/static/plugins/colorpicker/bootstrap-colorpicker.min.js"></script>
<!-- bootstrap time picker -->
<script src="${path}/static/plugins/timepicker/bootstrap-timepicker.min.js"></script>
<!-- SlimScroll 1.3.0 -->
...
<script src="${path}/static/plugins/fastclick/fastclick.js"></script>
<script src="${path}/static/plugins/colorpicker/bootstrap-colorpicker.min.js"></script>
<script src="${path }/static/dist/js/moment.min.js"></script>
...
<!-- bootstrap time picker -->
<script src="${path}/static/plugins/timepicker/bootstrap-timepicker.min.js"></script>
<script type="text/javascript" src="${path }/static/dist/js/wangEditor.min.js"></script>
