...
<section class="carts">
        <div class="container">
            <div class="title clearfix">
                <h3>我的拍卖</h3>
            </div> <form action="${path }/index/auctionlog/add" method="post">
            <div class="cart-box clearfix">
               <table class="col-xs-12 clearfix">
                  ...
                  <input type="hidden" name="nowprice" value="${record.nowprice }">
                    <tr class="no-h">
                        <td class="len-lg">选择</td>                        <c:if test="${record.type==1}">

                        <td class="len-sm no-see">现价(元)</td></c:if>
                        <td class="len-sm">加价</td>
                    </tr>
                    <tr>
                        <td>
                            <img src="${record.picurl}" alt="">
                            <span class="img_title"><a href="javascript: void (0)">${record.title }</a></span>
                        </td>                        <c:if test="${record.type==1}">
